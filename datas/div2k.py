...
class DIV2K(data.Dataset):
    def __init__(
        ...
        # hr_dir = os.path.join(self.cache_dir, 'df2k_hr', 'ycbcr' if self.colors==1 else 'rgb')
        # lr_dir = os.path.join(self.cache_dir, 'df2k_lr_x{}'.format(self.scale), 'ycbcr' if self.colors==1 else 'rgb')
