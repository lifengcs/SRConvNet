...
def create_datasets(args):
    ...
    train_dataloader = DataLoader(dataset=div2k, batch_size=args.batch_size, shuffle=True,
    ...
    if 'Manga109' in args.eval_sets:
        ...
        valid_dataloaders += [
            {'name': 'manga109', 'dataloader': DataLoader(dataset=manga, batch_size=1, shuffle=False)}]
